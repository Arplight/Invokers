...
const AdvantageCard: FC<IAdvantageCard> = ({
  ...
  return (
    <div className="bg-white p-2 flex flex-col gap-1 rounded-[10px] items-center w-[300px] hover:shadow-lg hover:shadow-[#ffffff50] duration-300 hover:-translate-y-1">
